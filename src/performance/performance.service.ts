...
export class PerformanceService {
  ...
  ): Promise<{ cycle: AppraisalCycleDocument; assignments: AppraisalAssignmentDocument[] }> {
  ...
  async upsertAppraisalRecord(
    ...
    if (assignment.managerProfileId.toString() !== managerProfileId) {
      throw new BadRequestException('Manager is not authorized for this assignment');
    }
